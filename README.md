...
电脑鼠迷宫上位机是苏州大学电子信息学院电信专业大四《电子系统设计》课程设计项目。本项目是一款专为电脑鼠（Micromouse）迷宫竞赛设计的可视化与控制系统，通过串口通信实时接收电脑鼠的位置、传感器数据等信息，并以直观的图形界面展示电脑鼠在迷宫中的运动轨迹、墙体信息、传感器状态等，同时支持轨迹回放、路径优化、数据导出等功能。
